...
#
#  heroku config:set DJANGO_SECRET_KEY='t82w_co6fp3q_r5to(+ky@!4v-d^z!iw6ur(289#7$8tbanqcx'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = 't82w_co6fp3q_r5to(+ky@!4v-d^z!iw6ur(289#7$8tbanqcx'
...
# if the environment variable is not defined then default to finalproject_db.sqlite3.
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///"+os.path.join(BASE_DIR, 'finalproject_db.sqlite3')),
}
